...
public class AIManager : MonoBehaviour
{
    ...
    public Vector2Int NewDefensiveCoordinates(Building reference_building) {
        System.Random rnd = new System.Random();
        Vector2Int coords = new Vector2Int(-1,-1);
	List<Vector2Int> cells = reference_building.GetInflucenceCellCoordinates();
    ...
    public Vector2Int NewExpansionCoordinates(Building reference_building) {
        System.Random rnd = new System.Random();
        Vector2Int coords = new Vector2Int(-1,-1);
        int min_dist = 999;
	List<Vector2Int> cells = reference_building.GetInflucenceCellCoordinates();
    ...
    public Vector2Int NewOffensiveCoordinates(Building reference_building) {
        System.Random rnd = new System.Random();
        Vector2Int coords = new Vector2Int(-1,-1);
        int min_dist = 999;
	List<Vector2Int> cells = reference_building.GetInflucenceCellCoordinates();
